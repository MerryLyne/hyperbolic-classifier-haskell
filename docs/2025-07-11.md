...
To be more specific we will use the Poincaré ball (or disk) which is a representation where every points are included in the area of the unit disk.
...
Python implementation and explanation (to help us understand) :
